...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailEditText = (EditText) findViewById(R.id.as_email_et);
        mNameEditText = (EditText) findViewById(R.id.as_name_et);
        mSurnameEditText = (EditText) findViewById(R.id.as_surname_et);
        mPhoneNoEditText = (EditText) findViewById(R.id.as_phone_et);
        mPasswordEditText = (EditText) findViewById(R.id.as_password_et);
        mConfirmPasswordEditText = (EditText) findViewById(R.id.as_password_confirm_et);
        mSignUpButton = (Button) findViewById(R.id.as_update_button);

        ActionBar ab = getSupportActionBar();

        SharedPreferences prefs = getSharedPreferences("AppPrefs", Context.MODE_PRIVATE);

        String currEmail = prefs.getString("USER_EMAIL", "Error");
        if (currEmail.equals("Error")){
