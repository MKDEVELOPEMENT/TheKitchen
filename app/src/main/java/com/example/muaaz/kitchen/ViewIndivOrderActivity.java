...
public class ViewIndivOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_indiv_order);
        ...
        ListAdapter mAdapter = new FirebaseListAdapter<KitchenItem>(this, KitchenItem.class, R.layout.menu_item_view_only_layout, orderRef) {

            @Override
            protected void populateView(View view, KitchenItem item, int position) {
